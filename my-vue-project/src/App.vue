...
<template>
  <div>
    ...
    <p v-if="showElement">This element is visible when showElement is true.</p>
    ...
    <div :class="{'highlight': isHighlighted}">
      This is a div that can be highlighted.
    </div>
  </div>
</template>
...
</style>./components/FooterOne.vue./components/PageFooter.vue
